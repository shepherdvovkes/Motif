"""
Simple MOTIF Song Text Analyzer (without NLTK dependency)
...
class SimpleSongAnalyzer:
    """Simple analyzer for song lyrics without NLTK dependency"""
